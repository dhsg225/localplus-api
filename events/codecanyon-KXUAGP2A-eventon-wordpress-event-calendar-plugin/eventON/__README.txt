...
EventON core PHP code: GPL v2 or later

NON-CODE ASSETS (CSS, JS, images, documentation):
PROPRIETARY LICENSE - All Rights Reserved
Copyright (C) 2014-2025 AshanJay Designs LLC

YOU MAY NOT: redistribute, resell, or publish these assets.
...
== Changelog ==
= 5.0.2 (2025-10-21) =
FIXED: Search not working after code refactor
FIXED: dynamic pid not working for shortcode add_single_eventon
FIXED: event top red outline removed when focused
FIXED: Event Card not opening up
FIXED: missing aria-label tag on buttons
UPDATED: EventON code licenses for GPL and non redistributable GPL assets

= 5.0.1 (2025-10-13) = 
ADDED: AI support for event color suggestions
FIXED: shortcode events list not maintaining event id
FIXED: single event box slide down not working
FIXED: event duration showing always
FIXED: Minor script issues from refactoring
FIXED: AI description generation not prompting well
FIXED: event type color override not working
UPDATED: AI event type, tags and colors responses to be arranged blocks
UPDATED: event description content HTML validity check code

= 5.0 (2025-10-8) = 
ADDED: option to open event map as expanded full page
ADDED: Ability to use event type colors on filter dropdown
ADDED: Ability to hide empty event taxonomy terms from filters
ADDED: subtitle column for events in wp-admin
ADDED: visibility option for multi data type additional fields
ADDED: default support upto 3 additional fields for multi data 
ADDED: the option to show duration of the event
ADDED: new shortcode option x_ids -- to exclude certain events from calendar
ADDED: Event type section for event card that open events in that category
ADDED: Side panel support for front-end
ADDED: Support for AI suggestions for event types, tags, summary & FAQs
ADDED: Ability to minimize AI Assist box
ADDED: Ability to delete AI responses
ADDED: FAQ section driven by new taxonomy
ADDED: Ability to use AI to generate FAQs and create new FAQs from AI response
ADDED: Search Eventon settings - beta version
ADDED: Ability to load eventon documentation articles within the site
ADDED: pre-set fields for multi data types as additional field option
ADDED: ability to sort multi data type values by preset fields
ADDED: Missing UTC timezone in the timezone list
ADDED: support for single event shortcode with dynamic post id from page
FIXED: Coming up next to hide if no events
FIXED: admin tooltip not closing properly
FIXED: event status reason colors not reflecting on calendar
FIXED: event repeat type translations not working in admin
FIXED: refresh live now calendar not working
FIXED: shortcode generator not loading inner step
FIXED: add to google calendar link breaking event page
FIXED: footer nav to scroll page to top of calendar for new month content
FIXED: repeat event page month
FIXED: lightbox image sizing issue
FIXED: eventon frontend script to only load on frontend of the website
FIXED: when no sorting options are selected, to hide sorting button
UPDATED: validate_request function to support no nonce verification
UPDATED: evo elements items layout and structure
UPDATED: horizontal slider with mobile support
UPDATED: switched to saving event taxonomy meta data into one array instead of many
UPDATED: Event edit page main event settings inside left menu based layout

= 4.9.12 (2025-8-20) = 
ADDED: Support for extra class names for eventon_anywhere button
ADDED: Support for location zip
ADDED: Microsoft Teams support for virtual events stream
ADDED: option to set how far ahead to look for next event in live now
FIXED: open event as single event page in new window not working
FIXED: eventon_get_unix_time()trim ampm value
FIXED: minor code issue at evo_cal_lightbox_trigger() in JS
FIXED: remove all custom styles not updating in settings
FIXED: export language CSV to have label column
FIXED: open single events in new window not working

= 4.9.11 (2025-7-17) =
FIXED: evo_admin_get_ajax on success support for trigger functions
FIXED: duplicating repeat events not working
FIXED: Import language via CSV to update on screen real-time
FIXED: feature image fit to min box height not working
FIXED: generate location latlng not working
FIXED: % sign in custom CSS not saving
FIXED: current month button not appearing correctly
FIXED: sorting and filtering elements to ADA buttons

= 4.9.10 (2025-6-30) = 
ADDED: Ability to hide upcoming events list on archive pages
ADDED: option to disable saving fusion/avada content into event post meta
ADDED: Ability to reload event edit event details without loading entire page
ADDED: Ability to hide past related events from releated events list on event
FIXED: archive page image lightbox aspect ratio not correct
FIXED: eventon license deactivation not registering in our server
FIXED: skip trashed events from releated events list
UPDATED: EventON settings UI

= 4.9.9 (2025-5-27) =
ADDED: Event post meta size values to Environment stats
ADDED: Ability to completely delete past events from website and database
ADDED: Ability to edit existing custom repeats
FIXED: Schedule view mobile layout
FIXED: lang value not properly set for new event data
FIXED: validation failing for taxonomy editor
FIXED: search bar open on load hiding when clicked on sort or filter
FIXED: Calendar not loading for non loggedin users
UPDATED: colorpicker element HTML and layout

= 4.9.8 (2025-5-19) = 
ADDED: evo_copycontent copy content to clipboard to elements code
ADDED: Support for eventon element dropdown with select multiple
ADDED: Support for evotooltipfree for front-end 
FIXED: CSV Export all events exporting location address twice
FIXED: Location upcoming events filter button not working
FIXED: Broken access control validations for admin functions
UPDATED: EVO_General_Elements library

= 4.9.7 (2025-5-5) = 
ADDED: OpenAI support for AI features
ADDED: Support for eventON license validation for purchases via myeventon.com
FIXED: XSS vulnerability when saving language settings data
FIXED: Tile box style 3 whole tile not clickable
FIXED: saving custom styles ! getting stripped away
FIXED: LFI error in class-evo-blocks.php

= 4.9.6 (2025-4-24) =
ADDED: Support for WP Classic editor with Add Media for custom meta field
FIXED: undefined vir_url
FIXED: event location archive page not loading
FIXED: hide loading google map if maps API is disabled
FIXED: ics time calculation
...
FIXED: evo_elm_form_presubmit_validation form not defined

= 4.9.5 (2025-4-9) =
FIXED: eventtop date styles
FIXED: Settings undefined error

= 4.9.4 (2025-4-9) =
FIXED: Eventtop text color styles settings not reflecting on event
FIXED: deprecated google map styles removed
...
FIXED: Moved cache events for calendar into settings option

= 4.9.2 (2025-4-1) = 
ADDED: evo_general_params with is_admin value
ADDED: object cache or trasients for event list quering
ADDED: AM PM to translating strings
FIXED: event ICS link to bypass nonce verification
FIXED: lightbox navigation not turning off
FIXED: eventtop content on top row color not syncing with rest of the text
FIXED: get_email_preview_html() for evo_helper to show preview emails
FIXED: css and js for dynamic_select element
FIXED: settings default evo elements fields are not getting the saved value
FIXED: Default event timezone not showing saved results
FIXED: EVO_Event::$start_unix_raw with null value
FIXED: eventtop showing a - for same day event
FIXED: Settings checkbox not saving all empty values
FIXED: event end time not in correct timezone
FIXED: input text fields with space showing &nbsp;
FIXED: eventcard designer color picker not working
FIXED: custom time format \ not working
FIXED: Event type categories not showing when previous event types are disabled
FIXED: crystal clear eventtop style layout
UPDATED: eventon settings UI 
UPDATED: Trumbowyg editor to version 2.31

= 4.9.1 (2025-3-10) =
FIXED: Classic editor not working
FIXED: language translations not working

= 4.9 (2025-3-5)=
ADDED: pluggable filter evo_eventcard_vir_post_content
ADDED: new elements into eventON elements class
ADDED: Filter admin events by event status
ADDED: Option to auto localize event time to visitor time
ADDED: Debug mode to record eventon custm debug messages into debug.log
ADDED: option to enable event details validation check via Settings > Diagnose
ADDED: Ability to navigate between lightbox events in lightbox view
ADDED: Ability to open event as lightbox on page load from url ../events/one-event/282/0/
ADDED: Admin event locations list to show location images
ADDED: Admin event organizers images to the list
FIXED: evo color picker element to use set hex color  
FIXED: saving settings to not erase existing values saved modually     
FIXED: saving EventON settings Styles stripping out the \   
FIXED: saving url value in settings not working    
FIXED: virtual event url showing in ics when set to show after rsvp or ticket
FIXED: ICS url not working  
FIXED: Tooltip not hiding properly
FIXED: ICS add to calendar DST incorrect times
FIXED: footer month nav arrows on rightside not working
FIXED: ux_val 3a white color eventtop text not showing white
UPDATED: switch to our own custom select2 dropdown field with search
UPDATED: Refactor admin all events page to cut down on memory use    
UPDATED: Default content loader animation style                         
