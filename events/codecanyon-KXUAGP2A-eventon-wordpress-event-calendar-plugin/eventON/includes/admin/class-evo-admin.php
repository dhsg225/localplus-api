	...
	public function eventon_admin_init() {	
		...
		// EVENT POSTS
			if ( $postType && $postType == "ajde_events" ) {	
				...
				$this->register_event_only_styles_scripts();
...
// admin styles and scripts
	// EVENTON Posts pages
		function register_event_only_styles_scripts(){
			wp_register_style( 'evo_event_post',AJDE_EVCAL_URL.'/assets/css/admin/event_post.css', array(), EVO()->version );
			wp_register_style( 'evo_select2',AJDE_EVCAL_URL.'/assets/lib/select2/select2.css',array(), EVO()->version);
			wp_register_script('evo_select2',AJDE_EVCAL_URL.'/assets/lib/select2/select2.min.js');
		...
		function eventon_admin_post_css() {
			...
			wp_enqueue_style( 'evo_event_post' );
			wp_enqueue_style( 'evo_select2');
		...
		function eventon_admin_post_script() {
			...
			if ( $typenow == '' || $typenow == "ajde_events" ) {
		        ...
		        wp_enqueue_script('evcal_backend_post');
