...
class evo_search{
	...
	public function __construct(){
		...
		add_filter('evo_cal_main_btns', array($this, 'header_search_button'), 10, 2);
		add_filter('evo_cal_header_end_content', array($this, 'header_search_bar'), 10, 2);
		...
		<div id='evo_search' class='EVOSR_section '>
			<div class="evo_search_entry">
				<p class='evosr_search_box' >
					<input class='evo_search_field evoff_2i' type="text" placeholder='<?php echo evo_lang_get('evoSR_001a','Search Calendar Events');?>' data-role="none">
			...
			<p class="evo_search_results_count evoff_2 evofz16" style='display:none'><span>10</span> <?php echo evo_lang_get('evoSR_004','Event(s) found');?></p>
			...
			?>					
				<div class='evo_search_bar <?php echo $search_show ? '' : 'evo_hidden';?>'>
					<div class='evo_search_bar_in' >
						<label for='saddr-input' class='sr-only'><?php evo_lang_get_e( 'evoSR_001', 'Search Events');?></label>		
						<input id='evo_search_bar_in_<?php echo EVO()->calendar->ID;?>' class='evo_search_bar_in_field' type="text" placeholder='<?php echo evo_lang_get( 'evoSR_001', 'Search Events');?>' data-role="none"/>
